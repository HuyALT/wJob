	...
	<div class="contain">
		...
		<main>
			<div class="container_block">
				<nav class="sidebar">
					<ul>
						<li class="sidebar-item active"><a href="#"> <i
								class="bx bx-cog"></i> <span> Quản lý tài khoản </span>
						</a></li>
				...
				<section class="detail-employer">
					...
					<div class="portfolio">
						<div class="user-info">
							...
							<form action="changepassword" id = "change-pass" class="account-info" method="post">
								<div class="input-box">
									<label for="" class="sub-title">Mật khẩu hiện tại </label> <input
										type="password" class="current-pass" name="old-pass" onkeyup="hidden_message()" placeholder=""
										value="" required />
								</div>
								<div class="input-box ">
									<label for="" class="sub-title">Mật khẩu mới: </label> <input
										type="password" class="new-pass" placeholder="" name="new-pass" value=""
										required />
								</div>
								<div class="input-box">
									<label for="" class="sub-title">Nhập lại mật khẩu: </label> <input
										type="password" class="repeat-pass" name="confirm-pass" placeholder="" value=""
										required />
								</div>
								<span style="color:${success?'green':'red'};" id="error-old-pass">${message}</span>
								<span style="color: red; display: none;" id="error-text">Mật khẩu xác nhận không chính xác</span>
						...
						<div class="user-info">
							...
							<form action="changeinfo" class="fields" method="post">
								<div class="input-box">
									<label for="" class="sub-title">Họ</label> <input
									name="ho"
										type="text" class="name" placeholder="" value="${ho}"
										required />
								</div>
								
								<div class="input-box">
									<label for="" class="sub-title">Tên </label> <input
									name="ten"
								...
								<div class="input-box ">
									<label for="" class="sub-title">CMND: </label> <input
										type="text" class="CMND/CCCD" placeholder=""
										name="cmnd"
										value="${cmnd}" required />
								</div>
								<div class="input-box">
									<label for="" class="sub-title">SDT: </label> <input
									name="sdt"
								...
								<div class="input-box">
									<label for="" class="sub-title">Ngày sinh: </label> <input
										type="date" class="birthday" placeholder="" value="${ngaysinh}" name="ngaysinh" required />
								</div>
								<div class="input-box">
									<label for="" class="sub-title">Địa chỉ: </label> <input
										style="max-width: 450px; width: 100%;" type="text" name="diachi"
										class="address"
										value="${diachi}"
										required />
								</div>
